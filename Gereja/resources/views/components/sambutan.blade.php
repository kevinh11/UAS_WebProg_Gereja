<div class="container-fluid sambutan d-flex flex-column flex-lg-row p-5">
    <div data-aos="fade-right" class="salam w-lg-50 w-100 p-2 order-lg-1 order-lg-2">
        <figure>
    ...
    <img data-aos="fade-left" src='images/agusSantoso.jpg' class='w-lg-50 sambutan-pic w-30 order-sm-1 order-sm-2'>
