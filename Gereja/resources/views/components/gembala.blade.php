<div class="justify-content-center flex d-flex flex-column align-items-center mt-3">
    <div>
...
<div  class="flex d-flex align-items-center justify-content-center flex-column p-2">
    ...
    <div class="container flex">
        <div id='keluarga-besar'class="row">
            ...
            <div class="col">
                <img src="images/pwk2.jpg" class="img-fluid">
            </div>
            <div class="col">
                <img src="images/keluargaBesar.jpg" class="img-fluid">
            </div>
        </div>
    </div>
